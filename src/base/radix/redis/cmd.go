...
// Eval calls Redis EVALSHA command.
func (c *Client) Evalsha(args ...interface{}) *Reply {
	return c.call(cmdEvalsha, args...)
}
...
// Freeze calls Redis FREEZE command.
func (c *Client) Freeze(args ...interface{}) *Reply {
	return c.call(cmdFreeze, args...)
}
...
// Melt calls Redis MELT command.
func (c *Client) Melt(args ...interface{}) *Reply {
	return c.call(cmdMelt, args...)
}
...
// Freeze queues a Redis FREEZE command for later execution.
func (mc *MultiCall) Freeze(args ...interface{}) {
	mc.call(cmdFreeze, args...)
}
...
// Melt queues a Redis MELT command for later execution.
func (mc *MultiCall) Melt(args ...interface{}) {
	mc.call(cmdMelt, args...)
}
